...
namespace WestSouth.IDP.Pages.Login;
...
public class Index : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (await _users.ValidateCredentialsAsync(Input.Username, Input.Password))
            {
                var user = await _users.GetUserByUserNameAsync(Input.Username);
